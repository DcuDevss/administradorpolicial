            ...
            <div class="block mt-4">
             ...
             <div class="flex justify-center mt-4">
                ...
                {{-- @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 font-semibold p-2 text-white hover:text-slate-400 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Registrar</a>
                 @endif
 --}}
