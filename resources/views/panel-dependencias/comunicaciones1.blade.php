    ...
    <section class="bg-slate-800">
        <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
          <h2 class="text-center text-4xl text-blue-400 font-bold tracking-tight sm:text-5xl">
            PANEL DE ADMINISTRACION DE INVENTARIO COMISARIA PRIMERA
          </h2>
          ...
          <div class="mt-12 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8">
            <blockquote class="rounded-lg bg-gray-100 p-8">
              <div class="flex items-center gap-4">
                ...
                /> --}}
                <div>
                  <a href="{{route('createComunicaciones1')}}" class="mt-1 text-lg font-medium text-gray-700">Ingresar Trabajo</a>
                </div>
              </div>
            </blockquote>
              ...
              <div class="flex items-center gap-4">
               {{-- <img
                ...
                <div>
                  ...
                  <a href="{{route('indexComunicaciones1')}}" class="mt-1 text-lg font-medium text-gray-700">Tabla de Dispositivos</a>
                </div>
              </div>
