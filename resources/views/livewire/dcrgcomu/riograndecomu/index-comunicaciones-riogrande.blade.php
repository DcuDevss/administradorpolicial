                            ...
                            <tbody class="text-sm divide-y divide-gray-100">
                                @foreach ($comunicaciones as $comu)
                                    <tr>
                                        ...
                                        <td class="text-center py-6 font-bold">{{ $comu->dependenciarg->nombre }}
                                        </td>
                                        <td class="text-center py-6 font-bold">
                                            {{ $comu->equipocomunicacion->nombre ?? '' }}
                                        </td>
                                        <td class="text-center py-6 font-bold">{{ $comu->marcaequipo->nombre ?? '' }}
                                        </td>
                                        ...
                                        <td class="text-center py-6 font-bold">
                                            {{ $comu->condicion_equipo_comunicacion ?? '' }}</td>
                                        ...
                                        <td class="text-center py-6 font-bold">{{ $comu->detalle_inventario ?? '' }}</td>
                                        <td class="text-center py-2 flex flex-col space-y-2">
                                            <a href="{{ route('editComunicacionesRiogrande', $comu->id) }}"
