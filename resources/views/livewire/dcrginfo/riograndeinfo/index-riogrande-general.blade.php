<div class="bg-slate-800 text-gray-900 tracking-wider leading-normal m-4">
                                    ...
                                    <tr>
                                       ...
                                       <td class="text-center py-6 font-bold">{{ $comu->destacamento->nombre ?? '----' }}</td> --}}
                                            ...
                                            @if ($comu->codigo_qr)
                                                <div x-data="{ open: false }">
                                                    <img x-on:click="open = !open"
                                                        src="{{ asset('storage/codigoQR/Riogrande/' . $comu->codigo_qr) }}"
                                                        alt="Código QR" class="cursor-pointer">

                                                    <div x-show="open"
                                                        class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
                                                        <div class="relative">
                                                            <img src="{{ asset('storage/codigoQR/Riogrande/' . $comu->codigo_qr) }}"
                                                ...
                                                <a href="{{ asset('storage/codigoQR/Riogrande/' . $comu->codigo_qr) }}"
                                                    download>
                                                    <button
                                        ...
                                        <td class="text-center py-2 flex flex-col space-y-2">
                                            <a href="{{ route('editRiograndeGeneral', $comu->id) }}"
    ...
    <div class="mt-4">
       <a href="{{ route('inventario-pdf-riogrande') }}"
