                                    ...
                                    @switch($button)
                                        @case('Comisaria Primera R.G')
                                            <div>
                                                <p class="text-metric-primary font-bold mb-2 text-xl">Total de Pc. en
                                                    Comisaria
                                                    Primera: <strong class="text-red-800">{{ $primeraPc }}</strong></p>
                                                ...
                                                <p class="text-metric-primary font-bold mb-2 text-xl">Pc Of. del Oficial
                                                ...
                                                <p class="text-metric-primary font-bold mb-2 text-xl">Pc Oficina de Jefe
                                                    de Turno
                                                ...
                                                <p class="text-metric-primary font-bold mb-2 text-xl">Otros equipos:
                                        ...
                                        @case('Comisaria Segunda R.G')
                                            <div>
                                                <p class="text-metric-primary font-bold mb-2 text-xl">Total de Pc. en
                                                    Comisaria
                                                    Segunda: <strong class="text-red-800">{{ $segundaPc }}</strong>
                                                </p>
                                                <p class="text-metric-primary font-bold mb-2 text-xl">Pc Oficina del
                                                    jefe:
                                                ...
                                                <p class="text-metric-primary font-bold mb-2 text-xl">Pc Oficina del Of.
                                                    servicio:
                                        ...
                                        @case('Comisaria Tercera R.G')
                                            <div>
                                                ...
                                                <p class="text-metric-primary font-bold mb-2 text-xl">Pc Oficina de Of.
                                                    sumariante:
                                        ...
                                        @case('Comisairia de Genero y Familia R.G')
                                            <div>
                                                <p class="text-metric-primary font-bold mb-2 text-xl">Total de pc en
                                                    Genero y Familia 1:
                                                ...
                                                <p class="text-metric-primary font-bold mb-2 text-xl">Pc Oficina de
                                                    Sevicios Externos: <strong
                                                        class="text-red-800">{{ $JefeTurnoPCFlia }}</strong></p>
                                        ...
                                        @case('D.S.E.R.G')
                                            <div>
                                                <div>
                                                    ...
                                                    <p class="text-metric-primary font-bold mb-2 text-xl">Seccion Canes:
                                                    ...
                                                    <p class="text-metric-primary font-bold mb-2 text-xl">Pc Of. Seccion
                                                        Explosivos:
                                        ...
                                        @case('D.R.Z.N')
                                            <div>
                                                ...
                                                <p class="text-metric-primary font-bold mb-2 text-xl">Pc Guardia:
                                        ...
                                        @case('Bienestar R.G')
                                            <div>
                                                ...
                                                <p class="text-metric-primary font-bold mb-2 text-xl">Otros equipos:
                                                    <strong v>{{ $bienestarotros }}</strong>
                                                </p>
                                            </div>
                                        @break
