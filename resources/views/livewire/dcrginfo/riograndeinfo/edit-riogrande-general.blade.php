                        ...
                        <div x-data="{ open: false }" class="shadow-lg">
                            ...
                            <div x-show.transition.in.duration.800ms="open" class="border p-4">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-10">
                                    ...
                                    <div class="mt-2">
                                        <label for="administracion_id"
                                            class="block text-text-gray-700 text-sm font-bold mb-1">Rio grande:</label>
                                    ...
                                    <div class="mt-2">
                                        <label for="slotmemoria_id"
                                            class="block text-text-gray-700 text-sm font-bold mb-1">Slot
                                            de memoria:</label>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text"
                                            ...
                                            wire:model="marca" placeholder="Marca" value="{{ $riogrande->marca }}" />
                                        @error('marca')
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="procesador"value="{{ $riogrande->procesador }}" />
                                        @error('procesador')
                                            <p class="text-red-500 text-xs">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ $riogrande->cant_almacenamiento }}" />
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="Tipo de servicio"value="{{ $riogrande->tipo_service }}" />
                                        @error('tipo_service')
                                            <p class="text-red-500 text-xs">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ $riogrande->sistema_operativo }}" />
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <select wire:model="activo" class="form-control w-full rounded-md">
                                            <option value="1" @if ($riogrande->activo) selected @endif>
                                                Activo</option>
                                            <option value="0" @if (!$riogrande->activo) selected @endif>
                                                Inactivo</option>
                                        </select>
                                        @error('activo')
                                            <span class="text-red-500">{{ $message }}</span>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ $riogrande->fecha_inventario }}" />
                                ...
                                <div class="mt-2">
                                    ...
                                    <textarea
                                        class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                        wire:model="softwares_instalados" placeholder="Ingrese Software"value="{{ $riogrande->softwares_instalados }}"></textarea>
                                ...
                                <div class="mt-2">
                                    ...
                                    <textarea
                                        class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                        wire:model="detalles_inventario" placeholder="Ingrese la Modificacion Realizada"value="{{ $riogrande->detalles_inventario }}"></textarea>
