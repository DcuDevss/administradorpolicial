                                        ...
                                        <div class="grid grid-cols-3 gap-3 mb-10">
                                            ...
                                            <div class="mt-1">
                                                <label class="block text-gray-700 text-sm font-bold mb-1"
                                                    for="numero_serie">N° de Serie:</label>
                                            ...
                                            <div class="mt-1">
                                                ...
                                                <input type="text" id="estado" name="estado"
                                                    class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                                    wire:model="estado"
                                                    placeholder="Estado del equipo de comunicacion" />
                                                @error('estado')
                                                    <p class="text-red-500 text-xs">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div x-show.transition.in.duration.800ms="open" class="border p-4">
                                                ...
                                                <div class="grid grid-cols-4 gap-2 mb-10">
                                                    <div>
                                                        ...
                                                        <p class="text-slate-800 text-lg font-bold mb-2">Total del Heramientas de medición:
                                                        ...
                                                        <p class="text-slate-800 text-lg font-bold mb-2">Total de Equipos de radio:
                                                            {{ $EquiporadioCount }}</p>
                                                        <p class="text-slate-800 text-lg font-bold mb-2">Total de Equippos de Radio en la guardia:
                                         ...
                                         <div x-data="{ open: false }" class="shadow-lg">
                                            <div @click="open = !open"
                                                 class="flex items-center justify-between bg-slate-800 border p-4 rounded-md transition">
                                                <p class="text-lg font-extrabold text-white">TABLA DE INVENTARIO D.C.U</p>
                                                    <span :class="open ? 'fa-chevron-down' : 'fa-chevron-up'" class="fas"></span>
                                            </div>
                                                <div x-show.transition.in.duration.800ms="open" class="border p-4">
                                                </div>
