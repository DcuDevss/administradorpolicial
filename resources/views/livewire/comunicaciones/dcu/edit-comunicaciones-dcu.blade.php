                        ...
                        <div x-data="{ open: false }" class="shadow-lg">
                            ...
                            <div x-show.transition.in.duration.800ms="open" class="border p-4">
                                ...
                                <div class="grid grid-cols-3 gap-3 mb-10">
                                    ...
                                    <div class="mt-2">
                                        <label for="nombre"
                                             class="block text-sm font-medium text-gray-700">Nombre del Elemento:</label>
                                        ...
                                        <div class="mt-2">
                                            <label for="marca"
                                                ...
                                                class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                                wire:model="marca"
                                                placeholder="ingrese la marca del elemento" />
                                            @error('marca')
                                                <p class="text-red-500 text-xs">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                            wire:model="modelo"
                                            placeholder="Ingrese el Modelo del Elemento" />
                                        @error('modelo')
                                            <p class="text-red-500 text-xs">{{ $message }}</p>
                                        @enderror
                                        </div>
                                        ...
                                        <div class="mt-1">
                                            <label class="block text-gray-700 text-sm font-bold mb-1" for="numero_serie">N° de Serie:</label>
                                            <input type="text" id="numero_serie" name="numero_serie"
                                                class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                                wire:model="numero_serie"
                                                placeholder="Ingrese N° de Serie del Elemento" />
                                            @error('numero_serie')
                                                <p class="text-red-500 text-xs">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mt-1">
                                            ...
                                            <input type="text" id="estado" name="estado"
                                                class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                                wire:model="estado"
                                                placeholder="Condición del Equipo de Comunicación" />
                                            @error('estado')
                                                <p class="text-red-500 text-xs">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mt-1">
                                        <label class="block text-gray-700 text-sm font-bold mb-1"
                                            for="detalle_inventario" id="detalle_inventario" name="detalle_inventario">Detalle del Inventario</label>
                                        <textarea
                                            class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
