                                ...
                                @foreach ($comunicaciones as $comu)
                                    <tr>
                                        ...
                                        <td class="text-center py-6 font-bold">
                                            {{ $comu->equipocomunicacion->nombre ?? 'No Encontrado' }}</td>
                                        <td class="text-center py-6 font-bold">
                                            {{ $comu->marcaequipo->nombre ?? 'No Encontrado' }}</td>
                                        <td class="text-center py-6 font-bold">
                                            {{ $comu->vhfantena->nombre ?? 'No Encontrado' }}</td>
                                        ...
                                        <td class="text-center py-6 font-bold">
                                            {{ $comu->lugar_colocacion ?? 'No Encontrado' }}</td>
                                        <td class="text-center py-6 font-bold">
                                            {{ $comu->condicion_equipo_comunicacion ?? 'No Encontrado' }}</td>
                                        <td class="text-center py-6 font-bold">{{ $comu->fecha_service ?? 'No Encontrado' }}
                                        </td>
                                        <td class="text-center py-6 font-bold">{{ $comu->tipo_service ?? 'No Encontrado' }}
                                        </td>
                                        <td class="text-center py-6 font-bold">
                                            {{ $comu->fecha_inventario ?? 'No Encontrado' }}</td>
                                        <td class="text-center py-6 font-bold">
                                        ...
                                        <td class="text-center py-2 flex flex-col space-y-2">
                                            <a href="{{ route('editComunicacionesAdministracion', $comu->id) }}"
                                            ...
                                            <a  href="{{ route('historial-trabajo-administracion', $comu->id) }}"
