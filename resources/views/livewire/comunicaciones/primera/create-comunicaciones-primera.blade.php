            ...
            <div class="flex flex-col p-4 shadow-lg">
                <div class="py-5 bg-white dark:bg-gray-100 rounded-md">
                            ...
                            <div x-show.transition.in.duration.800ms="open" class="border p-4">
                                ...
                                <div class="grid grid-cols-3 gap-3 mb-10">
                                    ...
                                    {{--  <div class="form-group row">
                                        <div class="col-md-6">
                                            <div class="col-md-12">
                                                <label for="tipo_objeto" class="font-bold">¿Qué te robaron?</label>
                                                <select name="tipo_objeto" id="tipo_objeto" class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md p-2">
                                                    <option value="" selected disabled>Seleccione Tipo de Objeto</option>
                                                    <option value="caballo">Animales - Caballo</option>
                                                    <option value="cabra">Animales - Cabra</option>
                                                    <!-- ... otras opciones ... -->
                                                </select>

                                            </div>
                                            <div id="formulario_caballo" class="hidden">
                                                <div class="col-md-12 campo-objeto">
                                                    <input name="nombre" type="text" class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md p-2" placeholder="Nombre" />
                                                </div>
                                                <div class="col-md-12 campo-objeto">
                                                    <input name="apellido" type="text" class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md p-2" placeholder="Apellido" />
                                                </div>
                                            </div>
                                            <div id="formulario_cabra" class="hidden">
                                                <div class="col-md-12 campo-objeto">
                                                    <input name="raza" type="text" class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md p-2" placeholder="Raza" />
                                                </div>
                                                <div class="col-md-12 campo-objeto">
                                                    <input name="color" type="text" class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md p-2" placeholder="Color" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <script>
                                        document.addEventListener("DOMContentLoaded", function() {
                                            const tipoObjetoSelect = document.getElementById("tipo_objeto");
                                            const formularioCaballo = document.getElementById("formulario_caballo");
                                            const formularioCabra = document.getElementById("formulario_cabra");

                                            tipoObjetoSelect.addEventListener("change", function() {
                                                formularioCaballo.classList.add("hidden");
                                                formularioCabra.classList.add("hidden");

                                                const selectedOption = tipoObjetoSelect.value;
                                                if (selectedOption === "caballo") {
                                                    formularioCaballo.classList.remove("hidden");
                                                } else if (selectedOption === "cabra") {
                                                    formularioCabra.classList.remove("hidden");
                                                }
                                            });
                                        });
                                    </script> --}}
                                    ...
                                    {{-- <div class="mt-1">
                                                <label class="block text-gray-700 text-sm font-bold mb-1" for="condicion_fuente">Condicion de la fuente
                                                       </label>
                                                <input type="text"
                                                    class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                                    wire:model="condicion_fuente" placeholder="Condeicion de la fuente" />
                                                @error('condicion_fuente')
                                                    <p class="text-red-500 text-xs">{{ $message }}</p>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mt-1">
                                                <label class="block text-gray-700 text-sm font-bold mb-1"
                                                    for="condicion_baliza">Condicion de la baliza
                                                </label>
                                                <input type="text"
                                                    class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                                    wire:model="condicion_baliza" placeholder="condicion de baliza" />
                                                @error('condicion_baliza')
                                                    <p class="text-red-500 text-xs">{{ $message }}</p>
                                                @enderror
                                            </div> --}}
                    ...
                    <div x-data="{ open: false }" class="shadow-lg">
                        <div @click="open = !open"
                            class="flex items-center justify-between bg-slate-800 border p-4 rounded-md transition">
                            <p class="text-lg font-extrabold text-white">ESTADISTICA COMISARIA PRIMERA</p>
                            <span :class="open ? 'fa-chevron-down' : 'fa-chevron-up'" class="fas"></span>
                        </div>
                        <div x-show.transition.in.duration.800ms="open" class="border p-4">
