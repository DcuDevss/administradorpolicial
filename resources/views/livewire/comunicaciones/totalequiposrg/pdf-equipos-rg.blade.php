<div>
    ...
    <div class="mb-4">
        ...
        <select class="w-full form-control" wire:model.live="dependenciaId">
    ...
    <div id="pdf-content" class="pdf-wrapper">
        ...
        <p style="text-align:center;margin-bottom:6mm;">
            <strong>Dependencia: {{ $depNombre }} Río Grande</strong>
        </p>
    ...
    <div wire:ignore>
        ...
        <script>
            window.descargarPdfEquiposRg = function () {
                ...
                html2pdf().set({
                    margin: [25, 15, 20, 15],
                    filename: `inventario_comunicacion_rg_${Date.now()}.pdf`,
