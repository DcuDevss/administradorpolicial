<div class="py-5  bg-slate-800  dark:bg-gray-100 ">
                ...
                <div class="py-5 bg-white dark:bg-gray-100 rounded-md">
                    <div x-data="{ open: false }" class="shadow-lg">
                        <div @click="open = !open"
                            ...
                            <p class="text-lg font-extrabold text-white">CUSTODIA GUBERNAMENTAL</p>
                    ...
                    <div x-data="{ open: false }" class="shadow-lg">
                        <div @click="open = !open"
                            class="flex items-center justify-between bg-slate-800 border p-4 rounded-md transition">
                            <p class="text-lg font-extrabold text-white">INVENTARIO CUSTODIA GUBERNAMENTAL</p>
                            <span :class="open ? 'fa-chevron-down' : 'fa-chevron-up'" class="fas"></span>
                        </div>
                        <div x-show.transition.in.duration.800ms="open" class="border p-4">
                            ...
                            <div class="grid grid-cols-4 gap-2 mb-10">
                                ...
                                <div>
                                    ...
                                    <p class="text-metric-secondary font-bold mb-2">Equipo Base
                                        Otros:{{ $baseotros }}</p>
                                    <p class="text-metric-secondary font-bold mb-2">Equipo Base
                                        Motorola:{{ $baseMotorola }}</p>
                                    <p class="text-metric-secondary font-bold mb-2">Equipo Base
                                        Kenwood:{{ $baseKenwood }}</p>
                                    <p class="text-metric-secondary font-bold mb-2">Equipo Base
                                        Yaesu:{{ $baseYaesu }}</p>
                                    <p class="text-metric-secondary font-bold mb-2">Equipo Base
                                        Hytera:{{ $baseHytera }}</p>
    ...
    @livewire('comunicaciones.custodia.index-comunicaciones-custodia')
</div>
