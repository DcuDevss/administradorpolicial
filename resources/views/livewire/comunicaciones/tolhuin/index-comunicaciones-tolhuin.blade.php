                            ...
                            <tbody class="text-sm divide-y divide-gray-100">
                                ...
                                @foreach ($comunicaciones as $comu)
                                    <tr>
                                        ...
                                        <td class="text-center py-6 font-bold">{{ $comu->dependenciatolhuin->nombre ?? 'Sin datos' }}
                                        </td>
                                        ...
                                        <td class="text-center py-2 flex flex-col space-y-2">
                                            <a href="{{ route('editComunicacionesTolhuin', $comu->id) }}"
                                            ...
                                            <a href="{{ route('historial-trabajo-tolhuin', $comu->id) }}"
