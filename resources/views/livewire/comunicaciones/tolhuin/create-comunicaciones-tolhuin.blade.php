<div class="py-5  bg-slate-800  dark:bg-gray-100 ">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
        ...
        <div class="col-xs-12">
                        ...
                        <div class="py-5 bg-white dark:bg-gray-100 rounded-md">
                            <div x-data="{ open: false }" class="shadow-lg">
                                <div @click="open = !open"
                                    ...
                                    <p class="text-lg font-medium text-white">TOLHUIN</p>
                            ...
                            <div x-data="{ open: false }" class="shadow-lg">
                                <div @click="open = !open"
                                    class="flex items-center justify-between bg-slate-800 border p-4 rounded-md transition">
                                    <p class="text-lg font-medium text-white">INVENTARIO TOLHUIN</p>
                                    <span :class="open ? 'fa-chevron-down' : 'fa-chevron-up'" class="fas"></span>
                                </div>
                                <div x-show.transition.in.duration.800ms="open" class="border p-4">
                                    ...
                                    <div class="grid grid-cols-4 gap-2 mb-10">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-purple-800 font-bold mb-2">Antena "Otros":
                                                {{ $Otros }}</p>
                                            <p class="text-purple-800 font-bold mb-2">Antena Dipolo 2:
                                                {{ $dipolo2 }}</p>
                                            <p class="text-purple-800 font-bold mb-2">Antena Dipolo 4:
                                                {{ $dipolo4 }}</p>
                                            <p class="text-purple-800 font-bold mb-2">Antena Dipolo 8:
                                                {{ $dipolo8 }}</p>
            ...
            @livewire('comunicaciones.tolhuin.index-comunicaciones-tolhuin')
        </div>
