                            ...
                            <tbody class="text-sm divide-y divide-gray-100">
                                ...
                                @foreach ($comunicaciones as $comu)
                                    <tr>
                                        ...
                                        <td class="text-center py-6 font-bold">{{ $comu->modelo ?? 'No Encontrado' }}
                                        </td>
                                        <td class="text-center py-6 font-bold">{{ $comu->nro_serie ?? 'No Encontrado' }}
                                        </td>
                                        <td class="text-center py-6 font-bold">
                                        ...
                                        <td class="text-center py-6 font-bold">
                                            {{ $comu->fecha_service ?? 'No Encontrado' }}</td>
                                        <td class="text-center py-6 font-bold">
                                            {{ $comu->tipo_service ?? 'No Encontrado' }}</td>
                                        <td class="text-center py-6 font-bold">
                                        ...
                                        <td class="text-center py-2 flex flex-col space-y-2">
                                            ...
                                            <a href="{{ route('historial-trabajo-segunda', $comu->id) }}"
