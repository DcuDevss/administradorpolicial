    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
        <x-slot name="header">
            <h2 class="font-semibold text-xl  text-red-500 leading-tight">
                {{ __('COMISARIA DE FAMILIA Y MINORIDAD DOS') }}
            </h2>
        </x-slot>
                    ...
                    <div class="py-5 bg-slate-800 dark:bg-gray-100">
                        <div x-data="{ open: false }" class="shadow-lg">
                            <div @click="open = !open"
                                ...
                                <p class="text-lg font-extrabold text-white">COMISARIA DE FAMILIA Y MINORIDAD DOS</p>
                            ...
                            <div x-show.transition.in.duration.800ms="open" class="border p-4">
                                <div class="grid grid-cols-3 gap-3 mb-10">
                                    ...
                                    <div class="mt-1">
                                        <label class="block text-gray-700 text-sm font-bold mb-1"
                                            for="vhfantena_id">Tipo de antena
                                        </label>
                       ...
                       {{--  <div x-data="{ open: false }" class="shadow-lg">
                        ...
                        <div class="mt-6">
                           ...
                           {{--  <button type="button" wire:click="closeModal"
                                class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">Cancelar
                            </button> --}}
                        </div>
                    </div>
                </div>
