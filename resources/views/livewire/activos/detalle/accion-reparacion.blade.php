   <div class="border-t border-gray-200 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-900/30">
       ...
       @if ($mostrarSolicitud)
           ...
           <div wire:key="modal-solicitud-reparacion-{{ $activo->id }}"
               class="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6">

               {{-- Fondo --}}
               <div wire:click="cerrarSolicitud" class="absolute inset-0 bg-black/70 backdrop-blur-sm">
               </div>



               <div class="relative z-[10000] flex w-full max-w-2xl flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl dark:border-gray-700 dark:bg-gray-800"
                   style="max-height: 90vh;">

                   <div class="shrink-0 border-b border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
                       ...
                       <div class="flex items-start justify-between gap-4">
                           ...
                           <div class="flex items-start gap-4">
                               ...
                               {{-- Icono --}}
                               <div
                                   class="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900/40">
                               ...
                               <div>
                                   ...
                                   <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                       Informá el problema que presenta este equipo.
                                   </p>
                           ...
                           {{-- Cerrar --}}
                           <button type="button" wire:click="cerrarSolicitud" wire:loading.attr="disabled"
                               class="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-gray-400 transition hover:bg-gray-100 hover:text-gray-600 disabled:cursor-not-allowed disabled:opacity-50 dark:hover:bg-gray-700 dark:hover:text-gray-200">
                       ...
                       <div class="space-y-6 p-6">
                           ...
                           <div>
                               ...
                               <div class="mb-4">
                                   ...
                                   <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                       Indicá qué sucede con el equipo para que el área técnica pueda
                               ...
                               <div>
                                   ...
                                   <label for="tituloSolicitud"
                                       class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                       Motivo de la solicitud
                                       <span class="text-red-500">*</span>
                                   </label>

                                   <input id="tituloSolicitud" type="text" wire:model="tituloSolicitud"
                                       maxlength="150" autocomplete="off" placeholder="Ej.: El equipo no enciende"
                               ...
                               <div class="mt-5">
                                   ...
                                   <label for="descripcionSolicitud"
                                       class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                       Descripción del problema
                                       <span class="text-red-500">*</span>
                                   </label>

                                   <textarea id="descripcionSolicitud" wire:model="descripcionSolicitud" rows="5" maxlength="5000"
                           ...
                           <div class="border-t border-gray-200 pt-6 dark:border-gray-700">
                               ...
                               <div class="mb-4">
                                   ...
                                   <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                       Seleccioná la prioridad que considerás adecuada según el impacto que
                                       tiene el problema.
                                   </p>
                               ...
                               <select id="prioridadSolicitud" wire:model="prioridadSolicitud"
                               ...
                               <div
                                   ...
                                   <div class="flex items-start gap-2">
                                       ...
                                       <svg class="mt-0.5 h-4 w-4 shrink-0 text-blue-600 dark:text-blue-400"
                                       ...
                                       <p class="text-xs leading-5 text-blue-700 dark:text-blue-300">
                                           La prioridad indicada es orientativa y podrá ser revisada
                                           posteriormente por el área técnica según la situación del
                                           equipo.
                                       </p>
                           ...
                           @error('general')
                               <div
                                   class="rounded-lg border border-red-200 bg-red-50 p-3 text-sm text-red-700 dark:border-red-900/40 dark:bg-red-900/20 dark:text-red-300">
                                   {{ $message }}
                               </div>
                           @enderror
                   ...
                   <div
                       class="shrink-0 border-t border-gray-200 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-900/30">

                       <div class="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">

                           {{-- Cancelar --}}
                           <button type="button" wire:click="cerrarSolicitud" wire:loading.attr="disabled"
                               wire:target="cerrarSolicitud"
                               class="inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-5 py-2.5 text-sm font-semibold text-gray-700 transition hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700">
                               Cancelar
                           </button>


                           {{-- Generar --}}
                           <button type="button" wire:click="guardarSolicitud" wire:loading.attr="disabled"
                               ...
                               <span wire:loading wire:target="guardarSolicitud" class="inline-flex items-center">
