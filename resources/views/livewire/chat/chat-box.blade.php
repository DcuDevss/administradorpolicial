    ...
    <div class="border-b flex flex-col overflow-y-scroll grow h-full">
        ...
        <main
            ...
            @scroll="
                ...
                if (scrollTop <= 0) {
                    // IMPORTANTE: Livewire con L mayúscula
                    ...
                    >
                        ...
                        <div
                            @class([
                                ...
                                'text-black bg-[#f6f6f8fb] rounded-bl-none border border-gray-200/40' => !($message->sender_id === auth()->id()),
        ...
        <footer class="shrink-0 z-10 bg-slate-800 inset-x-0">
            <div class="p-2 border-t">
                ...
                {{-- IMPORTANTE: submit nativo Livewire (sin Alpine) --}}
                <form wire:submit.prevent="sendMessage" autocapitalize="off">
                    <div class="grid grid-cols-12">
                        ...
                        <button
                            class="col-span-1 ml-3 bg-purple-900 rounded-md text-white"
                            type="submit"
