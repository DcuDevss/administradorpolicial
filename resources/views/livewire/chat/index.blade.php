<div class=" fixed  h-full  flex bg-slate-800 border  lg:shadow-sm overflow-hidden inset-0 lg:top-16  lg:inset-x-2 m-auto lg:h-[90%] rounded-t-lg">
    ...
    <div class="hidden md:grid   w-full border-l h-full relative overflow-y-auto" style="contain:content">
        ...
        <div class="m-auto text-center justify-center flex flex-col gap-3">
            ...
            <h4 class="font-medium text-lg text-red-200"> Elige una conversacion para empezar a dialogar </h4>
