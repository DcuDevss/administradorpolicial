                    ...
                    <div class="overflow-x-auto">
                        ...
                        <table class="w-full table-auto">
                            ...
                            <tbody class="text-sm divide-y divide-gray-100">
                                @foreach ($recurso as $comu)
                                    <tr>
                                        <td class="text-center py-6 font-bold">{{ $comu->id }}</td>
                                        <td class="text-center py-6 font-bold">{{ $comu->recursohumano->nombre ?? '----' }}</td>
                                        <td class="text-center py-6 font-bold">{{ $comu->bienestare->nombre ?? '----' }}</td>
                                        <td class="text-center py-6 font-bold">{{ $comu->sumario->nombre ?? '----' }}</td>
                                            ...
                                            @if ($comu->codigo_qr)
                                                <div x-data="{ open: false }">
                                                    <img x-on:click="open = !open"
                                                        src="{{ asset('storage/codigoQR/RecursosHumanos/' . $comu->codigo_qr) }}"
                                                        alt="Código QR" class="cursor-pointer">

                                                    <div x-show="open"
                                                        class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
                                                        <div class="relative">
                                                            <img src="{{ asset('storage/codigoQR/RecursosHumanos/' . $comu->codigo_qr) }}"
                                                ...
                                                <a href="{{ asset('storage/codigoQR/RecursosHumanos/' . $comu->codigo_qr) }}"
                                                    download>
                                                    <button
