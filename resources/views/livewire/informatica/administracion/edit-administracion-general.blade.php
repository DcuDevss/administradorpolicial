                        ...
                        <div x-data="{ open: false }" class="shadow-lg">
                            ...
                            <div x-show.transition.in.duration.800ms="open" class="border p-4">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-10">
                                    ...
                                    <div class="mt-1">
                                        <label class="block text-white text-sm font-bold mb-1"
                                            for="administracion_id">Administracion
                                        </label>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text"
                                            ...
                                            wire:model="marca" placeholder="Marca" value="{{ $administracion->marca }}" />
                                        @error('marca')
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="procesador"value="{{ $administracion->procesador }}" />
                                        @error('procesador')
                                            <p class="text-red-500 text-xs">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ $administracion->tipo_disco }}" />
                                        @error('tipo_disco')
                                            <p class="text-red-500 text-xs">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ $administracion->cant_almacenamiento }}" />
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ $administracion->tipo_teclado }}" />
                                        @error('tipo_teclado')
                                            <p class="text-red-500 text-xs">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ $administracion->tipo_mouse }}" />
                                        @error('tipo_mouse')
                                            <p class="text-red-500 text-xs">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ $administracion->fecha_service }}" />
                                        @error('fecha_service')
                                            <p class="text-red-500 text-xs">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="Tipo de servicio"value="{{ $administracion->tipo_service }}" />
                                        @error('tipo_service')
                                            <p class="text-red-500 text-xs">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ $administracion->sistema_operativo }}" />
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <select wire:model="activo" class="form-control w-full rounded-md">
                                            <option value="1" @if ($administracion->activo) selected @endif>
                                                Activo</option>
                                            <option value="0" @if (!$administracion->activo) selected @endif>
                                                Inactivo</option>
                                        </select>
                                        @error('activo')
                                            <span class="text-red-500">{{ $message }}</span>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ $administracion->fecha_inventario }}" />
                                ...
                                <div class="mt-2">
                                    ...
                                    <textarea
                                        class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                        wire:model="softwares_instalados" placeholder="Ingrese Software"value="{{ $administracion->softwares_instalados }}"></textarea>
                                ...
                                <div class="mt-2">
                                    ...
                                    <textarea
                                        class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                        wire:model="detalles_inventario" placeholder="Ingrese la modificación realizada"value="{{ $administracion->detalles_inventario }}"></textarea>
                                ...
                                <div class="mt-2 ml-80">
                                    ...
                                    @if ($administracion->codigo_qr)
                                        <img src="{{ asset('public/codigoQR/Administracion/' . $administracion->codigo_qr) }}"
