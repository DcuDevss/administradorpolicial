                            ...
                            <tbody class="text-sm divide-y divide-gray-100">
                                @foreach ($tol as $comu)
                                    <tr>
                                        ...
                                        <td class="text-center py-6 font-bold">{{ $comu->tolhuin->nombre ?? '----' }}</td> --}}
                                        <td class="text-center py-6 font-bold">{{ $comu->dependencia_tolhuin->nombre }}
                                        </td>
                                       <td class="text-center py-6 font-bold">{{ $comu->tipodeoficina->nombre ?? 'Sin Datos'}}</td>
                                       ...
                                       <td class="text-center py-6 font-bold">{{ $comu->destacamento->nombre ?? '----' }}</td> --}}
                                        <td class="text-center py-6 font-bold">{{ $comu->tipodispositivo->nombre ?? 'Sin Datos' }}</td>
                                        <td class="text-center py-6 font-bold">{{ $comu->marca ?? 'Sin Datos'}}</td>
                                        <td class="text-center py-6 font-bold">{{ $comu->modelo ?? 'Sin Datos'}}</td>
                                        <td class="text-center py-6 font-bold">{{ $comu->procesador ?? 'Sin Datos'}}</td>
                                        <td class="text-center py-6 font-bold">{{ $comu->sistema_operativo ?? 'Sin Datos'}}</td>
                                        <td class="text-center py-6 font-bold">{{ $comu->tipo_ram ?? 'Sin Datos'}}</td>
                                        <td class="text-center py-6 font-bold">{{ $comu->cantidadram->cantidad ?? 'Sin Datos' }}</td>
                                        <td class="text-center py-6 font-bold">{{ $comu->slotmemoria->cantidad ?? 'Sin Datos' }}</td>
                                        <td class="text-center py-6 font-bold">{{ $comu->tipo_disco ?? 'Sin Datos'}}</td>
                                        <td class="text-center py-6 font-bold">{{ $comu->cant_almacenamiento ?? 'Sin Datos'}}</td>
                                        ...
                                        <td class="text-center py-6 font-bold">{{ $comu->softwares_instalados ?? 'Sin Datos'}}</td>{{-- --}}
                                        <td class="text-center py-6 font-bold">{{ $comu->detalles_inventario ?? 'Sin Datos'}}</td>
                                            ...
                                            @if ($comu->codigo_qr)
                                                <div x-data="{ open: false }">
                                                    ...
                                                    <div x-show="open"
                                                        ...
                                                        <div class="relative">
                                                            <img src="{{ asset('storage/codigoQR/Tolhuin/' . $comu->codigo_qr) }}"
                                                ...
                                                <a href="{{ asset('storage/codigoQR/Tolhuin/' . $comu->codigo_qr) }}"
                                                    download>
                                                    <button
