<div class="bg-slate-800 text-gray-900 tracking-wider leading-normal m-4">
                                    ...
                                    <tr>
                                       ...
                                       <td class="text-center py-6 font-bold">{{ $comu->jefatura->nombre ?? '----' }}</td>
                                            ...
                                            @if ($comu->codigo_qr)
                                                <div x-data="{ open: false }">
                                                    ...
                                                    <div x-show="open"
                                                        ...
                                                        <div class="relative">
                                                            <img src="{{ asset('storage/codigoQR/Jefatura/' . $comu->codigo_qr) }}"
                                                ...
                                                <a href="{{ asset('storage/codigoQR/Jefatura/' . $comu->codigo_qr) }}"
                                                    download>
                                                    <button
                                        ...
                                        <td class="text-center py-2 flex flex-col space-y-2">
                                            ...
                                            <a href="{{ route('historial-jefatura-general', $comu->id) }}"
    ...
    <div class="mt-4">
       <a href="{{ route('inventario-pdf-jefatura') }}"
