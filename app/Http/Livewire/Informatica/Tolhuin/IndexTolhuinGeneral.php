...
class IndexTolhuinGeneral extends Component
{
    use WithPagination;
    public $buscar='';
    public $perPage1 = '4';
    ...
    public function render()
    {
        ...
        ->orWhereHas('dependencia_tolhuin', function ($query) {
            $query->where('nombre', 'like', "%{$this->search}%");
        })
        ->orWhereHas('tipodeoficina', function ($query) {
            $query->where('nombre', 'like', "%{$this->search}%");
        })
        ->orWhereHas('tolhuin', function ($query) {
            $query->where('nombre', 'like', "%{$this->search}%");
        })
        ...
        return view('livewire.informatica.tolhuin.index-tolhuin-general',compact('tol'));
    }
