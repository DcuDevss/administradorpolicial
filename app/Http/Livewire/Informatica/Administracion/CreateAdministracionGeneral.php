...
class CreateAdministracionGeneral extends Component
{
    ...
    $impresoraTinta = Administraciongenerale::where('tipodispositivo_id', 12)
        ...
        return view('livewire.informatica.administracion.create-administracion-general',compact('totalPc','directorPc','subjefePc',
        'segurosPc','adicionalPc','comprasPc','combustiblePc','patrimonioPc','juridicoPc','tesoreriaPc','automotoresPc','verificacionautomotoresPc',
        'armeriaPc','switch','ruter','servidor','camaras','centralTelefonica','telefonoFijo','impresoraLaser','impresoraTinta'));
    }
}
