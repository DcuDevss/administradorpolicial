   ...
   $cientificaPc =Investigacionesgenerale::where('investigacione_id', 13)
    ...
    $telefonoFijoCientifica =Investigacionesgenerale::where('investigacione_id', 13)
       ...
       /* $sumaTotalPc = DB::table('generalinformaticas')
            ...
            ->count();*/
        return view('livewire.informatica.investigaciones.create-investigaciones-general',compact('directorPc','segundoJefePc','prontuarioPc','reparPc','judicialPc','convenioPc','guardiaPc',
    'ciudadaniaPc','delitoscomplejosPc','narcocriminalidadPc','detalprontuarioPc','impresoraLaser','impresoraChorro',
'switch','ruter','camaras','servidor','centralTelefonica','telefonoFijo',
'cientificaPc','impresoraLaserCientifica','impresoraChorroCientifica','switchCientifica','ruterCientifica',
'camarasCientifica','servidorCientifica','centralTelefonicaCientifica','telefonoFijoCientifica'));
    }
}
