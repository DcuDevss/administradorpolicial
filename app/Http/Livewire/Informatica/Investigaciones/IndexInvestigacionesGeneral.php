...
class IndexInvestigacionesGeneral extends Component
{
    use WithPagination;
    public $buscar='';
    public $perPage1 = '4';
    ...
    public function render()
    {
        ...
        ->orWhereHas('investigacione', function ($query) {
        ...
        return view('livewire.informatica.investigaciones.index-investigaciones-general',compact('investigacion'));
    }
