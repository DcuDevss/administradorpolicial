...
class CreateRecursosGeneral extends Component
{
    ...
    public function guardarrecursoshumanos()
    {
       ...
       // try {
           ...
           // $this->tipodeoficina_id === null || $this->tipodeoficina_id === '' ? $this->admin->tipodeoficina_id = null : $this->admin->tipodeoficina_id = $this->tipodeoficina_id;
            ...
            $this->recursos->activo = $this->activo;
            $this->recursos->save();
 ...
 $telefonoFijoBienestar =Recursoshumanosgenerale::where('recurso_humano_id', 16)
     ...
     ->count();
        ...
        return view('livewire.informatica.recursos.create-recursos-general',compact('directorPc','segundoJefePc','segurosPc',
        'haberesPc','archivoPc','informaticaPc','juntaPc','asignacionesPc','guardiaPc',
        'secretariaPc','switch','ruter','servidor','camaras',
        'centralTelefonica','telefonoFijo','impresoraLaser','impresoraChorro','servidorPc','retirosPc','sumariosPc',
    'impresoraLaserSumario','impresoraChorroSumario','switchSumario','ruterSumario','camarasSumario','servidorSumario','centralTelefonicaSumario',
'telefonoFijoSumario','bienestarPc','impresoraLaserBienestar','impresoraChorroBienestar','switchBienestar','ruterBienestar','camarasBienestar',
'servidorBienestar','centralTelefonicaBienestar','telefonoFijoBienestar'));
    }
