...
class CreateJefaturaGeneral extends Component
{
    ...
    $impresoraTinta = Jefaturagenerale::where('tipodispositivo_id', 12)
        ...
        return view('livewire.informatica.jefatura.create-jefatura-general',compact('totalPc','jefePoliciaPc','subjefePoliciaPc',
        'asesoriaPc','analisisPc','informacionPc','scretariaPc','DGRZS_Pc','URS_Pc','subJefaturaPc',
        'guardiaPc','switch','ruter','servidor','camaras','centralTelefonica','telefonoFijo','impresoraLaser','impresoraTinta'));
    }
}
