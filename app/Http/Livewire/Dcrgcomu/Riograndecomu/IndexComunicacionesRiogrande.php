...
use App\Models\DependenciaRg;
use App\Models\Tipodoc;
use Carbon\Carbon;
use App\Models\Equipocomunicacion;


class IndexComunicacionesRiogrande extends Component
{
    use WithPagination;
    public $buscar='';
    public $perPage1 = '4';
    ...
    public function render()
    {
        ...
        ->orWhereHas('dependenciarg', function ($query) {
        ...
        return view('livewire.dcrgcomu.riograndecomu.index-comunicaciones-riogrande',compact('comunicaciones'));
    }
