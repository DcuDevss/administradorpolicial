...
class EditComunicacionesRiogrande extends Component
{

    use WithFileUploads;

    public $DependenciaRg = [];
    public $showingModal = false;

    public $codigo_qr,$dependencia_riogrande_id, $comunicacionesrg_id, $equipocomunicacion_id, $marcaequipo_id, $vhfantena_id, $lugar_colocacion, $modelo,
    $nro_serie, $condicion_equipo_comunicacion, $condicion_fuente, $condicion_baliza,
    $fecha_inventario, $fecha_service, $tipo_service, $detalle_inventario, $comunicacionesrg,$comunicaciones;
    public $MarcaEquipo;
    public $VhfAntena;
...
public function mount(Comunicacionesrg $comunicaciones)
{

    $this->DependenciaRg = DependenciaRioGrande::all();
    $this->MarcaEquipo = Marcaequipo::all();
    $this->VhfAntena = Vhfantena::all();
    $this->EquipoComunicacion = Equipocomunicacion::all();

    $this->dependencia_riogrande_id = $comunicaciones->dependencia_riogrande_id;
