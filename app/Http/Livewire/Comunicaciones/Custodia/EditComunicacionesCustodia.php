...
class EditComunicacionesCustodia extends Component
{
    ...
    $fecha_inventario, $fecha_service, $tipo_service, $detalle_inventario, $comunicacionescustodia,$comunicaciones;
    public $MarcaEquipo;
    public $VhfAntena;
...
public function mount(Comunicacionescustodia $comunicaciones)
{
...
public function edit()
{
    ...
    {
        return view('livewire.comunicaciones.custodia.edit-comunicaciones-custodia');
    }
}
