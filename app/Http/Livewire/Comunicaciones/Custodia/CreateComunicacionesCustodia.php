...
class CreateComunicacionesCustodia extends Component
{
    ...
    public function guardar()
    {
        ...
        try {
            ...
            $this->comunicacionescustodia->lugar_colocacion = $this->lugar_colocacion;
            $this->comunicacionescustodia->equipocomunicacion_id = $this->equipocomunicacion_id;
            $this->comunicacionescustodia->marcaequipo_id = $this->marcaequipo_id;
            $this->comunicacionescustodia->vhfantena_id = $this->vhfantena_id;
            $this->comunicacionescustodia->modelo = $this->modelo;
            $this->comunicacionescustodia->nro_serie = $this->nro_serie;
            $this->comunicacionescustodia->condicion_equipo_comunicacion = $this->condicion_equipo_comunicacion;
            ...
            $this->comunicacionescustodia->fecha_service = $this->fecha_service;
            $this->comunicacionescustodia->tipo_service = $this->tipo_service;
            $this->comunicacionescustodia->fecha_inventario = $this->fecha_inventario;
            $this->comunicacionescustodia->detalle_inventario = $this->detalle_inventario;
