...
class IndexComunicacionesNarco extends Component
{
    use WithPagination;
    public $buscar='';
    public $perPage1 = '4';
    ...
    {
        $comunicaciones = Comunicacionesnarco::where(function ($query) {
        ...
        return view('livewire.comunicaciones.narco.index-comunicaciones-narco',compact('comunicaciones'));
    }
