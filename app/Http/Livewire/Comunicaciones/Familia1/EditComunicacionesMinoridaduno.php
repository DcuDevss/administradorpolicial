...
class EditComunicacionesMinoridaduno extends Component
{
    ...
    $fecha_inventario, $fecha_service, $tipo_service, $detalle_inventario, $comunicacionesfamilia1,$comunicaciones;
    public $MarcaEquipo;
    public $VhfAntena;
...
public function mount(Comunicacionesfamilia1 $comunicaciones)
{
...
public function edit()
{
    ...
    {
        return view('livewire.comunicaciones.familia1.edit-comunicaciones-minoridaduno');
    }
}
