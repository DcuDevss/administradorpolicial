...
class IndexComunicacionesFamilia1 extends Component
{
    use WithPagination;
    public $buscar='';
    public $perPage1 = '4';
    ...
    {
        $comunicaciones = Comunicacionesfamilia1::where(function ($query) {
        ...
        return view('livewire.comunicaciones.familia1.index-comunicaciones-familia1',compact('comunicaciones'));
    }
