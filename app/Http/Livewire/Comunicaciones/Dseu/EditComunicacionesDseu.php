...
class EditComunicacionesDseu extends Component
{
    ...
    $fecha_inventario, $fecha_service, $tipo_service, $detalle_inventario, $comunicacionesdseu,$comunicaciones;
    public $MarcaEquipo;
    public $VhfAntena;
...
public function mount(Comunicacionesdseu $comunicaciones)
{
...
public function edit()
{
    ...
    {
        return view('livewire.comunicaciones.dseu.edit-comunicaciones-dseu');
    }
}
