...
class EditComunicacionesInvestigacion extends Component
{
    public $codigo_qr, $comunicacionesinvestigacion_id, $equipocomunicacion_id, $marcaequipo_id, $vhfantena_id, $lugar_colocacion, $modelo,
    $nro_serie, $condicion_equipo_comunicacion, $condicion_fuente, $condicion_baliza,
    $fecha_inventario, $fecha_service, $tipo_service, $detalle_inventario, $comunicacionesinvestigacion,$comunicaciones;
    public $MarcaEquipo;
    public $VhfAntena;
...
public function mount(Comunicacionesinvestigacion $comunicaciones)
{
...
public function edit()
{
    ...
    {
        return view('livewire.comunicaciones.investigacion.edit-comunicaciones-investigacion');
    }
}
