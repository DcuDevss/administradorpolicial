...
class IndexComunicacionesInvestigacion extends Component
{
    use WithPagination;
    public $buscar='';
    public $perPage1 = '4';
    ...
    {
        $comunicaciones = Comunicacionesinvestigacion::where(function ($query) {
        ...
        return view('livewire.comunicaciones.investigacion.index-comunicaciones-investigacion',compact('comunicaciones'));
    }
    ...
    {
        $registro = ComunicacionesInvestigacion::findOrFail($id);
