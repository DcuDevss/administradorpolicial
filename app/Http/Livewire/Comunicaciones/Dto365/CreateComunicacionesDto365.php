...
class CreateComunicacionesDto365 extends Component
{
    ...
    public function guardar()
    {
        ...
        try {
            ...
            $this->comunicacionesdto365->lugar_colocacion = $this->lugar_colocacion;
            $this->comunicacionesdto365->equipocomunicacion_id = $this->equipocomunicacion_id;
            $this->comunicacionesdto365->marcaequipo_id = $this->marcaequipo_id;
            $this->comunicacionesdto365->vhfantena_id = $this->vhfantena_id;
            $this->comunicacionesdto365->modelo = $this->modelo;
            $this->comunicacionesdto365->nro_serie = $this->nro_serie;
            $this->comunicacionesdto365->condicion_equipo_comunicacion = $this->condicion_equipo_comunicacion;
            ...
            $this->comunicacionesdto365->fecha_service = $this->fecha_service;
            $this->comunicacionesdto365->tipo_service = $this->tipo_service;
            $this->comunicacionesdto365->fecha_inventario = $this->fecha_inventario;
            $this->comunicacionesdto365->detalle_inventario = $this->detalle_inventario;
