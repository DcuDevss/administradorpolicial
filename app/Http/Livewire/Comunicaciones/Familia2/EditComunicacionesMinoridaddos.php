...
class EditComunicacionesMinoridaddos extends Component
{
    ...
    $fecha_inventario, $fecha_service, $tipo_service, $detalle_inventario, $comunicacionesfamilia2,$comunicaciones;
    public $MarcaEquipo;
    public $VhfAntena;
...
public function mount(Comunicacionesfamilia2 $comunicaciones)
{
