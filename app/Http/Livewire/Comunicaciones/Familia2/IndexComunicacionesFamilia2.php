...
class IndexComunicacionesFamilia2 extends Component
{
    use WithPagination;
    public $buscar='';
    public $perPage1 = '4';
    ...
    {
        $comunicaciones = Comunicacionesfamilia2::where(function ($query) {
        ...
        return view('livewire.comunicaciones.familia2.index-comunicaciones-familia2', compact('comunicaciones'));
    }
    ...
    {
        $registro = ComunicacionesFamilia2::findOrFail($id);
