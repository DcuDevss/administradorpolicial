...
class IndexComunicacionesCientifica extends Component
{
    ...
    {
        $comunicaciones = Comunicacionescientifica::where(function ($query) {
        ...
        return view('livewire.comunicaciones.cientifica.index-comunicaciones-cientifica',compact('comunicaciones'));
    }
