...
use App\Models\Comunicacionesdesu;
...
class IndexComunicacionesAdministracion extends Component
{
    use WithPagination;
    public $buscar='';
    public $perPage1 = '4';
    ...
    {
        $comunicaciones = Comunicacionesadministracion::where(function ($query) {
        ...
        return view('livewire.comunicaciones.administracion.index-comunicaciones-administracion',compact('comunicaciones'));
    }
    ...
    {
        $registro = ComunicacionesAdministracion::findOrFail($id);
