...
class EditComunicacionesCuarta extends Component
{
    ...
    $fecha_inventario, $fecha_service, $tipo_service, $detalle_inventario, $comunicacionescuarta,$comunicaciones;
    public $MarcaEquipo;
    public $VhfAntena;
...
public function mount(Comunicacionescuarta $comunicaciones)
{
