...
class IndexComunicacionesCuarta extends Component
{
    use WithPagination;
    public $buscar='';
    public $perPage1 = '4';
    ...
    {
        $comunicaciones = Comunicacionescuarta::where(function ($query) {
        ...
        return view('livewire.comunicaciones.cuarta.index-comunicaciones-cuarta',compact('comunicaciones'));
    }
    ...
    {
        $registro = ComunicacionesCuarta::findOrFail($id);
