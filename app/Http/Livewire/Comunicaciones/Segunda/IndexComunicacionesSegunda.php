...
class IndexComunicacionesSegunda extends Component
{
    use WithPagination;
    public $buscar='';
    public $perPage1 = '4';
    ...
    public function render()
    {
        ...
        return view('livewire.comunicaciones.segunda.index-comunicaciones-segunda',compact('comunicaciones'));
    }
    ...
    {
        $registro = ComunicacionesSegunda::findOrFail($id);
