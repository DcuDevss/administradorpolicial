...
class IndexComunicacionesRecurso extends Component
{
    use WithPagination;
    public $buscar='';
    public $perPage1 = '4';
    ...
    {
        $comunicaciones = Comunicacionesrecurso::where(function ($query) {
        ...
        return view('livewire.comunicaciones.recurso.index-comunicaciones-recurso',compact('comunicaciones'));
    }
    ...
    {
        $registro = ComunicacionesRecurso::findOrFail($id);
