...
class EditComunicacionesUshuaia extends Component
{
    ...
    public $codigo_qr,$dependencia_ushuaia_id, $comunicacionesushuaia_id, $equipocomunicacion_id, $marcaequipo_id, $vhfantena_id, $lugar_colocacion, $modelo,
    $nro_serie, $condicion_equipo_comunicacion, $condicion_fuente, $condicion_baliza,
    $fecha_inventario, $fecha_service, $tipo_service, $detalle_inventario, $comunicacionesushuaia,$comunicaciones;
    public $MarcaEquipo;
    public $VhfAntena;
...
public function mount(Comunicacionesushuaia $comunicaciones)
{
    ...
    $this->dependencia_ushuaia_id = $comunicaciones->dependencia_ushuaia_id;
...
public function edit()
{
    ...
    {
        return view('livewire.comunicaciones.ushuaia.edit-comunicaciones-ushuaia');
    }
}
