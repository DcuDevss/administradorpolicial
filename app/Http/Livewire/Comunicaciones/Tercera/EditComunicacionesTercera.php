...
class EditComunicacionesTercera extends Component
{
    ...
    $fecha_inventario, $fecha_service, $tipo_service, $detalle_inventario, $comunicacionestercera,$comunicaciones;
    public $MarcaEquipo;
    public $VhfAntena;
...
public function mount(Comunicacionestercera $comunicaciones)
{
...
public function edit()
{
    ...
    {
        return view('livewire.comunicaciones.tercera.edit-comunicaciones-tercera');
    }
}
