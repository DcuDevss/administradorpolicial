...
class EditComunicacionesQuinta extends Component
{
    ...
    $fecha_inventario, $fecha_service, $tipo_service, $detalle_inventario, $comunicacionesquinta,$comunicaciones;
    public $MarcaEquipo;
    public $VhfAntena;
...
public function mount(Comunicacionesquinta $comunicaciones)
{
