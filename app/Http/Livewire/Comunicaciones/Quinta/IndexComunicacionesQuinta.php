...
class IndexComunicacionesQuinta extends Component
{
    use WithPagination;
    public $buscar='';
    public $perPage1 = '4';
    ...
    {
        $comunicaciones = Comunicacionesquinta::where(function ($query) {
        ...
        return view('livewire.comunicaciones.quinta.index-comunicaciones-quinta',compact('comunicaciones'));
    }
