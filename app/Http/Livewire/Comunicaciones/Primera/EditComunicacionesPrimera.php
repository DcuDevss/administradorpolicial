...
class EditComunicacionesPrimera extends Component
{
    public $codigo_qr, $comunicacionesprimera_id, $equipocomunicacion_id, $marcaequipo_id, $vhfantena_id, $lugar_colocacion, $modelo,
        ...
        $fecha_inventario, $fecha_service, $tipo_service, $detalle_inventario, $comunicacionesprimera,$comunicaciones;
        public $MarcaEquipo;
        public $VhfAntena;
    ...
    public function mount(Comunicacionesprimera $comunicaciones)
    {
    ...
    {
        return view('livewire.comunicaciones.primera.edit-comunicaciones-primera');
    }
