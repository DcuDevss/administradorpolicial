...
#[ObservedBy(\App\Observers\ComunicacionessegundaObserver::class)]

class Comunicacionessegunda extends Model
{
    ...
    {
        return $this->hasMany(HistorialTrabajoSegunda::class);
    }
}
