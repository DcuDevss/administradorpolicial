...
class Comunicacionesushuaia extends Model
{
    use HasFactory;
    protected $fillable = [
        'codigo_qr','equipocomunicacion_id', 'dependencia_ushuaia_id', 'marcaequipo_id',  'lugar_colocacion', 'modelo',
    ...
    {
        return $this->hasMany(HistorialTrabajoUshuaia::class);
    }
}
