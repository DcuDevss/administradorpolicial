...
#[ObservedBy(\App\Observers\ComunicacionesFamilia2Observer::class)]

class Comunicacionesfamilia2 extends Model
{
    use HasFactory;
    use Auditable;
    protected $fillable = [
    ...
    {
        return $this->hasMany(HistorialTrabajoFamilia2::class);
    }
}
