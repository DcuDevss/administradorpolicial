...
#[ObservedBy(\App\Observers\ComunicacionesCustodiaObserver::class)]


class Comunicacionescustodia extends Model
{
    use HasFactory;
    use Auditable;
    protected $fillable = [
    ...
    {
        return $this->hasMany(HistorialTrabajoCustodia::class);
    }
}
