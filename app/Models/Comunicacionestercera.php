...
#[ObservedBy(\App\Observers\ComunicacionesTerceraObserver::class)]

class Comunicacionestercera extends Model
{
    use HasFactory;
    use Auditable;
    protected $fillable = [
    ...
    {
        return $this->hasMany(HistorialTrabajoTercera::class);
    }
}
