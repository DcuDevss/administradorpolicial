...
#[ObservedBy(\App\Observers\ComunicacionesComplejoObserver::class)]


class Comunicacionescomplejo extends Model
{
    use HasFactory;
    use Auditable;
    protected $fillable = [
    ...
    {
        return $this->hasMany(HistorialTrabajoComplejo::class);
    }
}
