...
#[ObservedBy(\App\Observers\Comunicacionesfamilia1Observer::class)]

class Comunicacionesfamilia1 extends Model
{
    use HasFactory;
    use Auditable;
    protected $fillable = [
    ...
    {
        return $this->hasMany(HistorialTrabajoFamilia1::class);
    }
}
