...
#[ObservedBy(\App\Observers\ComunicacionesAdministracionObserver::class)]


class Comunicacionesadministracion extends Model
{
    use HasFactory;
    use Auditable;
    protected $fillable = [
    ...
    {
        return $this->hasMany(HistorialTrabajoAdministracion::class);
    }
}
