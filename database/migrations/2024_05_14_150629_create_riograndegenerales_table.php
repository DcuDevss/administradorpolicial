...
return new class extends Migration
{
    ...
    {
        Schema::create('riograndegenerales', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('riogrande_id')->nullable();
            $table->foreign('riogrande_id')->references('id')->on('riograndes')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('riograndegenerales');
    }
};
