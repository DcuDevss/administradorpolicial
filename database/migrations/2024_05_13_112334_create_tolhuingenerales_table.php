...
return new class extends Migration
{
    ...
    {
        Schema::create('tolhuingenerales', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('tolhuin_id')->nullable();
            $table->foreign('tolhuin_id')->references('id')->on('tolhuins')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('tolhuingenerales');
    }
};
